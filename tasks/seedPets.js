...
async function main() {
    ...
    const butterscotch = await pets.addPet("Butterscotch",
        ...
        fur_shelter._id.toString(),
        90.00,
        ["child-friendly", "calico", "black", "white", "orange", "small-sized", "short-hair", "clawed", "house-trained"]
    );
    ...
    const lily = await pets.addPet("Lily",
        ...
        125.00,
        ["dog-friendly", "child-friendly", "tan", "gold", "yellow", "large-sized", "medium-hair", "active", "calm", "apartment-friendly", "house-trained"]
    );
