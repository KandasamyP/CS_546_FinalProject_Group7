...
async function main() {
  ...
  const michealanimalrescue = await shelters.create(
    "Micheal Scott Adoption Company",
    ...
    {
      facebook: "facebook.com/michealscottanimalrescue",
      instagram: "instagram.com/michealscottanimalrescue",
      twitter: "twitter.com/michealscottanimalrescue",
    },
  ...
  const dwightanimalrescue = await shelters.create(
    "Dwight K shrute Adoption Company",
    ...
    {
      facebook: "facebook.com/dwightschruteanimalrescue",
      instagram: "instagram.dwightshruteanimalrescue",
      twitter: "twitter.com/dwightschruteanimalrescue",
    },
    ["6063d472f5a17f32a5cbdc24", "6064a5d02f56e4da24413ab3"],
    ["6064a5f081004bcfbc33d6c5"],
    [
  ...
  const jimanimalrescue = await shelters.create(
    "Jim Helpert Adoption Company",
    ...
    {
      facebook: "facebook.com/jimhelpertanimalrescue",
      instagram: "instagram/jimhelpertanimalrescue",
      twitter: "twitter.com/jimhelpertanimalrescue",
    },
    ["6063d472f5a17f32a5cbdc24", "6064a5d02f56e4da24413ab3"],
    ["6064a5f081004bcfbc33d6c5"],
    [
  ...
  const pamanimalrescue = await shelters.create(
    "Pam beesly Adoption Company",
    ...
    {
      facebook: "facebook.com/pambeeslyanimalrescue",
      instagram: "instagram.com/pambeeslyanimalrescue",
      twitter: "twitter.com/pambeeslyanimalrescue",
    },
    ["6063d472f5a17f32a5cbdc24", "6064a5d02f56e4da24413ab3"],
    ["6064a5f081004bcfbc33d6c5"],
    [
  ...
  const kellyanimalrescue = await shelters.create(
    "kelly kapoor Adoption Company",
    ...
    {
      facebook: "facebook.com/kellykapooranimalrescue",
      instagram: "instagram.com/kelyykapooranimalrescue",
      twitter: "twitter.com/kellykapooranimalrescue",
    },
    ["6063d472f5a17f32a5cbdc24", "6064a5d02f56e4da24413ab3"],
    ["6064a5f081004bcfbc33d6c5"],
    [
  ...
  const ryananimalrescue = await shelters.create(
    "ryan howard Adoption Company",
    ...
    {
      facebook: "facebook.com/ryanhowardanimalrescue",
      instagram: "instagram.com/ryanhowardanimalrescue",
      twitter: "twitter.com/ryanhowardanimalrescue",
    },
    ["6063d472f5a17f32a5cbdc24", "6064a5d02f56e4da24413ab3"],
    ["6064a5f081004bcfbc33d6c5"],
    [
