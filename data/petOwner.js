  ...
  try {
    if (petOwnerEmail === undefined || petOwnerEmail.trim() === "") {
      throw {
        status: 400,
        error:
          "Email must be provided. Generated by /data/petOwner/getPetOwnerByUserEmail",
      };
    }
    ...
    if (petOwnerDetails == null || !petOwnerDetails)
      throw {
        status: 404,
        error:
          "petOwner/adopter User not found. Generated by /data/petOwner/getPetOwnerByUserEmail",
      };
  ...
  try {
    if (!petOwnerId) {
      throw {
        status: 400,
        error:
          "Missing petOwner/adopter id. Generated by data/petOwner/getPetOwnerById",
      };
    }
    if (!ObjectId.isValid(petOwnerId)) {
      throw {
        status: 400,
        error:
          "Invalid petOwner/adopter id. Generated by data/petOwner/getPetOwnerById",
      };
    }
    ...
    if (petOwnerDetails == null || !petOwnerDetails)
      throw {
        status: 404,
        error:
          "petOwner/adopter not found. Generated by data/petOwner/getPetOwnerById",
      };
  ...
  try {
    if (updatedData.biography) {
      if (typeof updatedData.biography !== "string") {
        throw {
          status: 400,
          error:
            "Biography is not a string. Generated by data/petOwner/updatePetOwner",
        };
      }
    }
    ...
    if (updatedData.fullName) {
      if (
        ...
        typeof updatedData.fullName.firstName !== "string"
      ) {
        throw {
          status: 400,
          error:
            "firstname is not a string. Generated by data/petOwner/updatePetOwner",
        };
      }
    }
    ...
    if (updatedData.fullName) {
      if (
        ...
        typeof updatedData.fullName.lastName !== "string"
      ) {
        throw {
          status: 400,
          error:
    ...
    if (updatedData.zipCode) {
      if (zipcodes.lookup(updatedData.zipCode) === undefined) {
        throw {
          status: 400,
          error:
            "Invalid zip code . Generated by data/petOwner/updatePetOwner ",
        };
      }
    }
    ...
    if (updatedData.phoneNumber) {
      if (!phoneNumberRegex.test(updatedData.phoneNumber)) {
        throw {
          status: 400,
          error:
            "Invalid phone number . Generated by data/petOwner/updatePetOwner ",
        };
      }
    }
    ...
    if (updatedData.dateOfBirth) {
      if (!dateChecker(updatedData.dateOfBirth)) {
        throw {
          status: 400,
          error:
            "Date can not be a future date. Generated by data/petOwner/updatePetOwner.",
        };
      }
    }
    ...
    if (updatedData.fullName) {
      if (
        ...
        modifiedData.fullName["firstName"] =
          existingUserData.fullName.firstName;
      }
      if (
        updatedData.fullName.hasOwnProperty("lastName") &&
    ...
    if (updateInfo.matchedCount === 0 && updateInfo.modifiedCount === 0)
      throw {
        status: 500,
        error:
          "Could not update petOwner/Adopter. Generated by data/petOwner/updatePetOwner ",
      };
  ...
  try {
    if (!req) {
      throw {
        status: 400,
        error:
          "req missing. Generated by /data/petOwner/updatePetOwnerFeedbackById",
      };
    }
    const petOwnerCollection = await petOwnerData();
    ...
    if (updateInfo.modifiedCount === 0)
      throw {
        status: 500,
        error:
          "Not able to update db.Generated by /data/petOwner/updatePetOwnerFeedbackById",
      };
  } catch (e) {
    throw { status: e.status, error: e.error };
  }
  ...
  try {
    ...
    if (!userId) {
      throw {
        status: 400,
        error:
          "User id must be provided. Generated by data/petOwner/updatePassword",
      };
    }
    if (!ObjectId.isValid(userId)) {
      throw {
        status: 400,
        error:
          "Invalid petOwner/adopter id. Generated by Generated by data/petOwner/updatePassword",
      };
    }
    if (!plainTextPassword) {
      throw {
        status: 400,
        error:
          "password must be provided.Generated by data/petOwner/updatePassword",
      };
    }
    ...
    if (plainTextPassword.trim().length < 6) {
      throw {
        status: 400,
        error:
          "Password must contain at least 6 characters. Generated by data/petOwner/updatePassword",
      };
    }
    ...
    if (updateInfo.matchedCount === 0 && updateInfo.modifiedCount === 0)
      throw {
        status: 500,
        error:
          "Could not update password.Generated by data/petOwner/updatePassword",
      };
  ...
  try {
    if (email === undefined || email.trim() === "") {
      throw {
        status: 400,
        error:
          "Email must be provided. Generated by /data/petOwner/updateProfileImage",
      };
    }
    ...
    if (updateInfo.matchedCount === 0 && updateInfo.modifiedCount === 0)
      throw {
        status: 500,
        error:
          "Could not update profile picture.Generated by /data/petOwner/updateProfileImage ",
      };
  ...
  try {
    if (!userId) {
      throw {
        status: 400,
        error:
          "User id must be provided. Generated by data/petOwner/getShelterReviews",
      };
    }
    if (!ObjectId.isValid(userId)) {
      throw {
        status: 400,
        error:
          "Invalid petOwner/adopter id. Generated by Generated by data/petOwner/getShelterReviews",
      };
    }
    ...
    for (let index = 0; index < shelterReviewsArray.length; index++) {
      ...
      const shelterReviewDetails = await shelterAndRescueCollection.findOne(
        { "reviews._id": shelterReviewsArray[index] },
      ...
      for (
        let reviewIndex = 0;
        reviewIndex < shelterReviewDetails.reviews.length;
        reviewIndex++
      ) {
...
async function getUserFavoritePets(favoritePetArray) {
  try {
    if (!Array.isArray(favoritePetArray))
      throw {
        status: 400,
        error:
          "favoritePets must be an array generated by data/petOwner/getUserFavoritePets",
      };
    ...
    for (let i = 0; i < favoritePetArray.length; i++) {
      ...
      if (petDetails == null)
        throw {
          status: 500,
          error:
            "pet not found. generated by data/petOwner/getUserFavoritePets",
        };
  ...
  try {
    if (!userId) {
      throw {
        status: 400,
        error:
          "User id must be provided. Generated by data/petOwner/updateVolunteerStatus",
      };
    }
    if (!ObjectId.isValid(userId)) {
      throw {
        status: 400,
        error:
          "Invalid petOwner/adopter id. Generated by Generated by data/petOwner/updateVolunteerStatus",
      };
    }
    if (!status || status.trim() == "") {
      throw {
        status: 400,
        error:
          "status must be provided.Generated by data/petOwner/updateVolunteerStatus",
      };
    }
    ...
    if (updateInfo.matchedCount === 0 && updateInfo.modifiedCount === 0)
      throw {
        status: 500,
        error:
          " Could not update password. generated by /data/petOwner/updateVolunteerStatus",
      };
  ...
  try {
    ...
    if (shelterData == null)
      throw {
        status: 404,
        error:
          "shelter data does not exist. generated by /data/petOwner/getPetCount",
      };
    let total = 0;
  ...
  try {
    if (!id)
      throw {
        status: 400,
        error:
          "The input id is missing. generated by /data/petOwner/getAllUsersWithFavoritePet",
      };
    ...
    if (typeof id !== "string")
      throw {
        status: 400,
        error:
          "The input must be a string. generated by /data/petOwner/getAllUsersWithFavoritePet",
      };
    if (id.trim().length === 0)
      throw {
        status: 400,
        error:
          "The input must not be empty. generated by /data/petOwner/getAllUsersWithFavoritePet",
      };
    ...
    let userResults = await userCollection
      .find({ favoritedPets: id })
      .toArray();
    let userIds = [];
  ...
  try {
    if (!petOwnerId || !reviewId) {
      throw {
        status: 400,
        error:
          "User id must be provided. Generated by data/petOwner/updateShelterReviewsGiven",
      };
    }
    if (!ObjectId.isValid(petOwnerId) || !ObjectId.isValid(reviewId)) {
      throw {
        status: 400,
        error:
          "Invalid petOwner/adopter id. Generated by Generated by data/petOwner/updateShelterReviewsGiven",
      };
    }
