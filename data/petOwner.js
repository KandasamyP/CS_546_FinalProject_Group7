...
async function updatePetOwner(updatedData) {
  try{
    ...
    if (!updatedData.fullName || !updatedData.fullName.hasOwnProperty("firstName") ||!updatedData.fullName.hasOwnProperty("lasttName") ||
        !updatedData.phoneNumber || !updatedData.zipCode || !updatedData.dateOfBirth ){
