...
let exportedMethods = {
  ...
  async updateShelter(updatedData) {
    ...
    if (updatedData.location) {
      if (
        ...
        modifiedData.location["streetAddress1"] =
          updatedData.location.streetAddress1;
      } else {
        modifiedData.location["streetAddress1"] =
          existingUserData.location.streetAddress1;
      }
      if (
        updatedData.location.hasOwnProperty("streetAddress2") &&
        updatedData.location.streetAddress2.trim() != ""
      ) {
        modifiedData.location["streetAddress2"] =
          updatedData.location.streetAddress2;
      } else {
        modifiedData.location["streetAddress2"] =
          existingUserData.location.streetAddress2;
      }
      if (
      ...
      if (
        ...
        modifiedData.location["stateCode"] =
          existingUserData.location.stateCode;
      }
      if (
  ...
  async updateShelterFeedbackById(req) {
    ...
    let feedback = req.body.experience;

    if (!rating || rating.trim() === "" || rating === undefined)
      throw {
        status: 400,
        error:
          "Rating must be provided. Generated by /data/shelterAndRescue/updateShelterFeedbackById",
      };
    if (!feedback || feedback.trim() === "" || feedback === undefined)
      throw {
        status: 400,
        error:
          "Feedback must be provided. Generated by /data/shelterAndRescue/updateShelterFeedbackById",
      };
    ...
    const updateInfo = await sheltersColl.updateOne(
    ...
    try {
      if (userEmail === undefined || userEmail.trim() === "") {
        throw {
          status: 400,
          error:
            "Email must be provided. Generated by /data/shelterAndRescue/getUserByEmail",
        };
      }
      ...
      if (!validateEmail(userEmail)) {
        throw {
          status: 400,
          error:
            "E-Mail not in correct format. Generated by /data/shelterAndRescue/getUserByEmail",
        };
      }
      const sheltersCollection = await shelterAndRescue();
