...
let exportedMethods = {
  ...
  async updateShelterFeedbackById(req) {
    ...
    if (!rating || rating.trim() === "" || rating === undefined)
      throw {
        status: 400,
        error: "Rating must be provided. Generated by /data/shelterAndRescue/updateShelterFeedbackById",
      }
    if (!feedback || feedback.trim() === "" || feedback === undefined)
      throw {
        status: 400,
        error: "Feedback must be provided. Generated by /data/shelterAndRescue/updateShelterFeedbackById",
      }
  ...
  async getUserByEmail(userEmail) {
    try {
      if (userEmail === undefined || userEmail.trim() === ""){
        throw {
          status: 400,
          error: "Email must be provided. Generated by /data/shelterAndRescue/getUserByEmail",
        }
      }
